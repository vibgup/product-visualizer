...
$("#tableCarousel .li-carousal").click(function() {
...
$("#sofaCarousel .li-carousal").click(function() {
    backGroundCtx.clearRect(0, 0, backgroundCanvas.width, backgroundCanvas.height);
    if (this.id !== 'remove') {
...
$('#carouselExampleFade1').on('slide.bs.carousel', function (props) {
  console.log(props);
  var toId = props.to + 1;
  backGroundCtx.clearRect(0, 0, backgroundCanvas.width, backgroundCanvas.height);
...
$('#carouselExampleFade2').on('slide.bs.carousel', function (props) {
  console.log(props);
  var toId = props.to + 1;
  backGroundCtx.clearRect(0, 0, backgroundCanvas.width, backgroundCanvas.height);
